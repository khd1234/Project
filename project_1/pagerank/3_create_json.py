...
print("Creating JSON output on json.js...")
...
if maxrank == minrank or maxrank is None or minrank is None:
    print("Error - please run Rank_algorithm.py to compute page rank")
    quit()
...
print("OPEN 3_visualization.html IN BROWSER TO SEE THE VISUAL")
